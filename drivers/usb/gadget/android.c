...
#define DRIVER_DESC		"Android Composite USB Driver"
...
static int __ref android_bind(struct usb_composite_dev *cdev)
{
	struct android_dev *dev = _android_dev;
...
static int __exit android_usb_unbind(struct usb_composite_dev *cdev)
{
	struct android_dev *dev = _android_dev;
...
static struct usb_composite_driver android_usb_driver = {
	...
	.unbind		= __exit_p(android_usb_unbind),
