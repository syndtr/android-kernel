...
#define GPIO_WIFI_EN			S5PV210_GPB(5)
#define GPIO_WIFI_RST			S5PV210_GPG1(2)
#define GPIO_WIFI_WAKE			S5PV210_GPG3(5)
#define GPIO_WIFI_WAKE_INT		S5PV210_GPH2(4)

/* Audio */

#define GPIO_CODEC_LDO_EN		S5PV210_GPF3(4)
#define GPIO_MICBIAS_EN			S5PV210_GPJ4(2)
#define GPIO_MICBIAS_EAR_EN		S5PV210_GPJ4(4)
